...
//     join_result.write_to_excel("C:\\Borivoj\\RUST\\Elusion\\Excel\\sales.xlsx", Some("Kurac")).await?;
...
//     result.write_to_excel("C:\\Borivoj\\RUST\\Elusion\\Excel\\sales2.xlsx", Some("string_interop")).await?;

//     -==== FILTERING

//     let sales_ord_path = "C:\\Borivoj\\RUST\\Elusion\\sales_order_report2.csv";
//     let sales_order_df = CustomDataFrame::new(sales_ord_path, "so").await?;
...
//         filter_query.display().await?;

//         filter_query.write_to_excel("C:\\Borivoj\\RUST\\Elusion\\Excel\\filter.xlsx", None).await?;
...
//     let df_extracted = json_df.clone().json([
//         "Value.'$Value' aS column_name_1",
//         "Value.'$ValueKind' As column_name_2",
//         "Value.'$Id' AS column_name_3"
//     ])
//     .select(["Id", "TenantId"])
...
//     // ======= JSON 2
//     let multiple_values = json_df.json_array([
//         "Value.'$Value:Id=DateCompleted' as date",
//         "Value.'$Value:Id=CompletedBy' AS completed",
//         "Value.'$Value:Id=Timeline' as timeline",
//         "Value.'$Value:Id=PSC_1' AS psc_1",
//         "Value.'$Value:Id=PSC_2' Aa psc_2", 
//         "Value.'$Value:Id=PSC_3' aS psc_3"
//         ])
//     .select(["Id"])
...
//     let path_excel = "C:\\Borivoj\\RUST\\Elusion\\Excel\\sales2.xlsx";
//     let df = CustomDataFrame::new(path_excel, "tets").await?;


//     let result = df.select(["*"]).elusion("ds").await?;

//     result.display().await?;

//     Example 1: Load from a full path
//     let df1 = CustomDataFrame::load_excel_from_sharefile(
//         "advancedmetrics.sharefileftp.com",
//         990,
//         "advancedmetrics/njeremic@ametrics.org",
//         "Nikola!!2024",
//         "/Nikola Test/Autism_CANS/Wesley_Autism_CANS_07-25-2024.xlsx",
//         "excel_data"
//     ).await?;

//     df1.display().await?;

//     Example 2: Load with base path and filename separated 
//     let df2 = CustomDataFrame::load_excel_from_sharefile_with_path(
//         "advancedmetrics.sharefileftp.com",
//         990,
//         "advancedmetrics/njeremic@ametrics.org",
//         "Nikola!!2024",
//         "/Nikola Test/Autism_CANS",
//         "Wesley_Autism_CANS_07-25-2024.xlsx",
//         "excel_data"
//     ).await?;
...
//     let files = CustomDataFrame::list_sharefile_files(
//         "amets.sharefileftp.com",
//         990,
//         "amets/akfa@adas.org",
//         "pass123",
//         Some("/Nikola Test/Autism_CANS")
//     )?;


//     // Now use the DataFrame as they would any other
//     df2.select(["column1", "column2"])
//     .filter("column1 > 10")
//     .elusion("filtered_data")
//     .await?;
 ...
 let df = CustomDataFrame::load_excel_from_sharepoint(
    "3a7ce086-472b-46b3-aa95-b978c322b880",
    "f300fe57-4dac-433c-ba67-caa5efba1072", 
    "http://expertgrouprs.sharepoint.com/sites/TopTal", 
    "Shared Documents/Rikkas/DailySalesFiles/NiniveBAS/Sales 07172025.xlsx",
    ).await?;

    let sales_data = df
        .select(["Sales_By_Revenue_Centre_By_Location","Column_1","Column_2","Column_3","Column_4","Column_5","Column_6","Column_7","Column_8","Column_9"])
